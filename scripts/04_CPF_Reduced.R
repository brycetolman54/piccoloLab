...
saveRDS(recipe, "recipes/04_CPF_Reduced.rds")
...
saveRDS(fitModel, "models/04_CPF_Reduced.rds")
...
for(dataSet in dataSetVariables) {
    ...
    rocCurve(fitModel,
             ...
             mdText = "CPF Reduced Gene Set (n=100)",
...
rm(i, genes, dataSet, dataSets, dataSetVariables,
   setName, subFolder, readFiles, bakeFiles,
   mdMetrics, rocCurve, model, formula, split)
